...
with st.expander("Klik untuk membaca Sejarah Singkat SpongeBob SquarePants", expanded=False):
    ...
    **SpongeBob SquarePants** diciptakan oleh ahli biologi laut dan animator **Stephen Hillenburg**.
    ...
    Acara ini dengan cepat menjadi salah satu serial animasi terpanjang dan paling populer, disukai oleh anak-anak maupun orang dewasa di seluruh dunia karena humornya yang unik dan karakter-karakter utamanya yang ikonik.
    """)
